    ...
    return(
        <>
            ...
            <View  style={styles.gameboard}>
                <MaterialCommunityIcons name="information" size={40} color="#ea23dd"/>
                {!hasPlayerName ? 
                    <>
                        <Text>Give name for Scoreboard</Text>
                        <TextInput onChangeText={setPlayerName} autoFocus={true} style={styles.buttonText}/>
